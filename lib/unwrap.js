...
module.exports = function (options) {
	...
	var dirname = path.dirname(file);
	var targetContent = fs.readFileSync(file, 'utf-8');
	var commonjs = fs.readFileSync(__dirname + '/common.js', 'utf-8');//if the encoding option is specified then this function returns a string. Otherwise it return a buffer.
